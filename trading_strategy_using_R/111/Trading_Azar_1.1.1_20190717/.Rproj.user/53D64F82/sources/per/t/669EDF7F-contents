...
##### ........... =====
##### WinDT =====
Win_DT <- getWin_DT(DataTable, SelectCol = input$SelectCol, StartDate = input$StartDate, EndDate = input$EndDate)
...
# Wt_Riskparit <- MVaR_CVaR_Riskparity$Wt
# MVaR_Riskparit <- MVaR_CVaR_Riskparity$MVaR
# CVaR_Riskparit <- MVaR_CVaR_Riskparity$CVaR
...
RL_Markowitz_Wt <- get_RL_Markowitz_Wt(RL_Markowitz, col_name = base::setdiff(colnames(Portfolio_All$Equity_All), "Index")[-1])
...
RL_RiskParity_Wt <- get_RL_RiskParity_Wt(RL_RiskParity, col_name = base::setdiff(colnames(Portfolio_All$Equity_All), "Index")[-1])
...
RL_CVaR_Wt <- get_RL_CVaR_Wt(RL_CVaR, col_name = base::setdiff(colnames(Portfolio_All$Equity_All), "Index")[-1])
...
plot_ly(MarkowitzCor_Plotly, type = 'scatter', x = ~index,  
        y = ~Index, name = 'Index',  mode = 'lines',hoverinfo = 'text',
        text = ~paste('Index Corr : ', Index, '<br /> Date: ', index)) %>%
