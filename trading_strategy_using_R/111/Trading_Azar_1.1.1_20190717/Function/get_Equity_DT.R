...
##### get_Equity_DT =====
get_Equity_DT <- function(Index_Ret, Equity_MACD, Equity_RSI, Equity_MA, Equity_BB, Equity_Dist) {
  
  # Index_Ret <-  Ret_DT
  Index_Ret$index <- as.Date(Index_Ret$index)
  ...
  Index_Ret_XTS <- as.xts.data.table(Index_Ret)
  ...
  Equity_XTS <- merge(Index_Ret_XTS,
                      Equity_MACD_XTS,
                      Equity_RSI_XTS,
                      Equity_MA_XTS,
                      Equity_BB_XTS,
