...
# fun_for_macd<-function(Select_DT){
#   Ret_DT <- getRet_DT(Select_DT)
#   
#   ##### MACD Strategy =====
...
Equity_RSI <- getEquity_DT(Ret_DT, MACD_Signal)
...
##### ........... =====
##### Equity_All =====
Equity_All <- get_Equity_DT(Equity_MACD, Equity_RSI, Equity_MA, Equity_BB, Equity_Dist, Equity_Corr)
...
plot_ly(Portfolio_Ret_Plotly, x = ~index, y = ~MACD,
  ...
  add_trace(y = ~Corr, name = 'Corr', mode = 'lines',hoverinfo = 'text',
            text = ~paste('Corr CumRet : ', Corr,'<br /> Date: ', index)) %>% 
...
plot_ly(Portfolio_DD_Plotly, x = ~index, y = ~MACD,
  ...
  add_trace(y = ~Corr, name = 'Corr', mode = 'lines',hoverinfo = 'text',
            text = ~paste('Corr DD : ', Corr,'<br /> Date: ', index)) %>% 
...
RL_Markowitz_Wt <- get_RL_Markowitz_Wt(RL_Markowitz, col_name = colnames(Portfolio_All$Equity_All)[-1])
...
RL_RiskParity_Wt <- get_RL_RiskParity_Wt(RL_RiskParity, col_name = colnames(Portfolio_All$Equity_All)[-1])
...
RL_CVaR_Wt <- get_RL_CVaR_Wt(RL_CVaR, col_name = colnames(Portfolio_All$Equity_All)[-1])
...
plot_ly(MarkowitzCor_Plotly, x = ~index, y = ~MACD, 
        name = 'MACD', type = 'scatter', mode = 'lines',hoverinfo = 'text',
  ...
  add_trace(y = ~Corr, name = 'Corr', mode = 'lines',hoverinfo = 'text',
            text = ~paste('Corr Corr : ', Corr, '<br /> Date: ', index)) %>% 
  layout(title = "Markowitz Portfolio Correlation",
         xaxis = list(title = ''),
...
plot_ly(MarkowitzWt, x = ~Period, y = ~MACD, 
  ...
  add_bars(y = ~Corr, name = 'Corr',hoverinfo = 'text',
           text = ~paste('Corr Wt : ', Corr, '<br /> Date: ', index)) %>% 
...
plot_ly(MarkowitzCumRet_Plotly, x = ~index, y = ~CumRet, name = 'Ret', 
        type = 'scatter', mode = 'lines',hoverinfo = 'text',
        text = ~paste('CumRet : ', CumRet, '<br /> Date: ', index)) %>% 
  layout(title = "Markowitz Portfolio Rolling Cumulative Return",
         xaxis = list(title = ''),
         yaxis = list(title = 'Cumulative Return'))
...
plot_ly(RiskParityCor_Plotly, x = ~index, y = ~MACD,
        name = 'MACD', type = 'scatter', mode = 'lines',hoverinfo = 'text',
        text = ~paste('MACD Corr : ', MACD, '<br /> Date: ', index)) %>%
  add_trace(y = ~RSI, name = 'RSI', mode = 'lines',hoverinfo = 'text',
            text = ~paste('RSI Corr : ', RSI, '<br /> Date: ', index)) %>%
  ...
  add_trace(y = ~Corr, name = 'Corr', mode = 'lines',hoverinfo = 'text',
            text = ~paste('Corr Corr : ', Corr, '<br /> Date: ', index)) %>% 
  layout(title = "RiskParity Portfolio Correlation",
         xaxis = list(title = ''),
         yaxis = list(title = 'Correlation'))
...
plot_ly(RiskParityCumRet_Plotly, x = ~index, y = ~CumRet, name = 'Ret',
        type = 'scatter', mode = 'lines',hoverinfo = 'text',
        text = ~paste('CumRet : ', CumRet, '<br /> Date: ', index)) %>% 
  layout(title = "RiskParity Portfolio Rolling Cumulative Return",
         xaxis = list(title = ''),
         yaxis = list(title = 'Cumulative Return'))
...
plot_ly(CVaRCor_Plotly, x = ~index, y = ~MACD,
        name = 'MACD', type = 'scatter', mode = 'lines',hoverinfo = 'text',
        text = ~paste('MACD Corr : ', MACD, '<br /> Date: ', index)) %>%
  add_trace(y = ~RSI, name = 'RSI', mode = 'lines',hoverinfo = 'text',
            text = ~paste('RSI Corr : ', RSI, '<br /> Date: ', index)) %>%
  ...
  add_trace(y = ~Corr, name = 'Corr', mode = 'lines',hoverinfo = 'text',
            text = ~paste('Corr Corr : ', Corr, '<br /> Date: ', index)) %>% 
  layout(title = "CVaR Portfolio Correlation",
         xaxis = list(title = ''),
         yaxis = list(title = 'Correlation'))
...
plot_ly(CVaRCumRet_Plotly, x = ~index, y = ~CumRet, name = 'Ret',
        type = 'scatter', mode = 'lines',hoverinfo = 'text',
        text = ~paste('CumRet : ', CumRet, '<br /> Date: ', index)) %>% 
  layout(title = "CVaR Portfolio Rolling Cumulative Return",
         xaxis = list(title = ''),
         yaxis = list(title = 'Cumulative Return'))
